...
export default function PhotosUploader({ photos, setPhotos }) {
  ...
  function selectAsMainPhoto(ev,filename){
    ev.preventDefault()
    const notSelectedPhotos = photos.filter(photos=>photos!=filename)
          ...
          photos.map((link) => (
            <div key={link} className="h-32 flex relative">
              ...
              <button
                ...
                className="absolute right-1 bottom-1 bg-black bg-opacity-50 p-1 text-white rounded-xl"
              >
                <svg
              ...
              <div
                ...
                className="absolute left-1 bottom-1 text-white bg-black bg-opacity-50 rounded-xl p-1"
              >
                {link === photos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
