    ...
    <div>
      <header className="flex justify-between">
        ...
        <a href="/" className="flex items-center">
          ...
          <span className="font-bold text-xl text-primary">aircnc</span>
        </a>
        {/* Search Bar */}
        <div className="flex gap-2 border border-gray-3f00 rounded-full px-4 py-2 shadow-md shadow-gray-400">
          <div>Anywhere</div>
